#!/usr/bin/env bash
PATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:~/bin:/usr/bin/python3
export PATH
#
...
libsodium_url='https://github.com/xuchunwen/shadowsocks_install/releases/download/1.0.0/libsodium-1.0.18.tar.gz'

mbedtls_file='mbedtls-2.16.12'
mbedtls_url='https://github.com/xuchunwen/shadowsocks_install/releases/download/1.0.0/mbedtls-2.16.12.tar.gz'

shadowsocks_python_file='shadowsocks_python'
shadowsocks_python_url='https://github.com/xuchunwen/shadowsocks_install/releases/download/1.0.0/shadowsocks_python.zip'
shadowsocks_python_init='/etc/init.d/shadowsocks-python'
shadowsocks_python_config='/etc/shadowsocks-python/config.json'
shadowsocks_python_centos='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocks'
shadowsocks_python_debian='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocks-debian'

shadowsocks_r_file='shadowsocksr-3.2.2'
shadowsocks_r_url='https://github.com/xuchunwen/shadowsocks_install/releases/download/1.0.0/shadowsocksr-3.2.2.tar.gz'
shadowsocks_r_init='/etc/init.d/shadowsocks-r'
shadowsocks_r_config='/etc/shadowsocks-r/config.json'
shadowsocks_r_centos='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocksR'
shadowsocks_r_debian='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocksR-debian'

shadowsocks_go_file_64='shadowsocks-server-linux64-1.2.2'
shadowsocks_go_url_64='https://github.com/xuchunwen/shadowsocks_install/releases/download/1.0.0/shadowsocks-server-linux64-1.2.2.gz'
shadowsocks_go_file_32='shadowsocks-server-linux32-1.2.2'
shadowsocks_go_url_32='https://github.com/xuchunwen/shadowsocks_install/releases/download/1.0.0/shadowsocks-server-linux32-1.2.2.gz'
shadowsocks_go_init='/etc/init.d/shadowsocks-go'
shadowsocks_go_config='/etc/shadowsocks-go/config.json'
shadowsocks_go_centos='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocks-go'
shadowsocks_go_debian='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocks-go-debian'

shadowsocks_libev_init='/etc/init.d/shadowsocks-libev'
shadowsocks_libev_config='/etc/shadowsocks-libev/config.json'
shadowsocks_libev_centos='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocks-libev'
shadowsocks_libev_debian='https://raw.githubusercontent.com/xuchunwen/shadowsocks_install/master/shadowsocks-libev-debian'
...
install_prepare_port() {
    ...
    read -p "(Default port: 8090):" shadowsocksport
    [ -z "${shadowsocksport}" ] && shadowsocksport=8090
